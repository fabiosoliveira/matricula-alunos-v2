  ...
  return (
    ...
    <form role="form" onSubmit={handleSubmit}>
      ...
      <BoxWithToolsAndBorder title="Dados pessoais" visivel={true}>
        ...
        <div className="row">
          ...
          <Field
            ...
            label="SUS"
            cols="12 3"
            placeholder="Informe o número do SUS"
            {...susMask}
          />
          <Field
            name="cpf"
        ...
        <div className="row">
          <Fields
            names={["endereco.id", "endereco.endereco"]}
            component={SelectBusca}
            readOnly={readOnly}
            label="Endereço"
            cols="12 6"
            icon="search"
      ...
      <BoxWithToolsAndBorder title="Documentos" visivel={false}>
        <div className="row">
          ...
          <Field
            ...
            label="Emissor"
            cols="12 3"
            placeholder="Informe o Emissor do RG"
          />
        </div>
        <div className="row">
          <Field
      ...
      <BoxWithToolsAndBorder title="Responsável">
        ...
        <Field
          name="responsavel.rg.numeroRegistro"
          component={Input}
          readOnly={readOnly}
          label="RG"
          cols="12 3"
        ...
        />
        <Field
          name="responsavel.rg.dataEspedicao"
          component={Input}
          readOnly={readOnly}
          label="Data Expedição"
          cols="12 3"
      ...
      <BoxWithToolsAndBorder title="Quiz">
        ...
        <Field
          name="quiz.procedimentoEscolar"
          component={Select}
          readOnly={readOnly}
          label="Procedimento Escolar"
          cols="12 6"
        >
          <option></option>
          <option value="CHAMAR-RESPONSAVEL">
            ligar para o responsável e aguardar na unidade escolar
          </option>
          <option value="LEVAR-AO-HOSPITAL">
            levar ao hospital e solicitar acompanhamento do responsável
          </option>
        </Field>
        <Field
          name="quiz.necessidadeEspecial"
          component={Input}
          readOnly={readOnly}
          label="Necessidade especial"
          cols="12 6"
          placeholder="Informe alguma necessidade especial caso possua"
        />
        <Field
          name="quiz.tratamentoEspecial"
          component={Input}
          readOnly={readOnly}
          label="Tratamento especial"
          cols="12 6"
          placeholder="Informe alguma tratamento especial que esteja fazendo"
        />
        <Field
          name="quiz.algumaAlergia"
          component={Input}
          readOnly={readOnly}
          label="Alergias"
          cols="12 6"
          placeholder="Informe as alergias que tenha"
        />
        <Field
          name="quiz.algumMedicamentoContinuado"
          component={Input}
          readOnly={readOnly}
          label="Medicamento continuado"
          cols="12 6"
          placeholder="Informe os medicamentos continuados"
        />
      </BoxWithToolsAndBorder>
...
const mapStateToProps = state => ({
  alunoForm: state.form[ALUNO_FORM],
  tab: state.tab
});
