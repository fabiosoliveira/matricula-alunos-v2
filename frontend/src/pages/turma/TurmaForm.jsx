...
let TurmaForm = ({
  ...
  function calculateSummary() {
    ...
    return {
      ...
      somaDeReprovado: matriculados.filter(c => c.status === "REPROVADO")
        .length,
      somaDeDesistente: matriculados.filter(c => c.status === "DESISTENTE")
        .length
    };
  }
  ...
  return (
    ...
    <form role="form" onSubmit={handleSubmit}>
      <div className="box-body">
        ...
        <Summary
          cursando={somaDeCursando}
          aprovado={somaDeAprovado}
          reprovado={somaDeReprovado}
          desistente={somaDeDesistente}
        />
        <ItemList
          cols="12"
          list={matriculados}
