  ...
  return (
    <div>
      ...
      <table className="table table-condensed">
        ...
        <tfoot>
          <tr>{keys.map(renderFooter)}</tr>
        </tfoot>
      </table>
      <div className="flex-between table-pagination">
        <span>
          Showing {page * limit - (limit - 1)} to {page * data.length} of{" "}
          {count} entries
        </span>
        <nav aria-label="...">
          <ul className="pagination">
            <li className={isLimitPreview ? "disabled" : ""}>
              <a
                href="#"
                onClick={handlePage(isLimitPreview ? 1 : page - 1)}
                aria-label="Previous"
              >
            ...
            <li className={isLimitNext ? "disabled" : ""}>
              <a
                href="#"
                onClick={handlePage(isLimitNext ? page : page + 1)}
                aria-label="Next"
              >
